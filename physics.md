...
|:--:| 
| *The "theory space" of standard physics models, based on three fundamental constants (image stolen from John Baez). Classical physics is correct in the limit that G = h = 1/c = 0.* |
